...
public class AdvancedActivity extends AppCompatActivity {
    ...
    private Button leftBracket, rightBracket, sin, cos, tan, ln, sqrt, xsquare, xpowy, log;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.threeButton);
        ...
        button3 = findViewById(R.id.oneButton);
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(expression.isEmpty()==false){
                    ...
                    if(Character.isDigit(lastChar) == true || lastChar==')')
                        setResultText("+");
                }
            }
        });
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(expression.isEmpty()==true){
                    ...
                    char lastChar = expression.charAt(expression.length()-1);
                    if(Character.isDigit(lastChar) == true || lastChar==')' || lastChar=='^')
                        setResultText("-");
                }
        ...
        xsquare = findViewById(R.id.xSquareButton);
        ...
        xpowy = findViewById(R.id.xPowYButton);
